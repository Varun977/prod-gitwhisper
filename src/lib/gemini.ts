...
A line that starting with \'-\' means that line wos deleted.
...
export async function summarizeCode(doc: Document) {
  ...
  try {
    ...
    const response = await model.generateContent([
      `You are an intelligent senior software engineer who specializes in onboarding junior developers onto projects`,
